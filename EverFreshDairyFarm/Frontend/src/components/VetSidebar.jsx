...
function CowRegistrationSidebar() {
  return (
    <div className="flex flex-col h-full p-5 bg-green-800 text-white w-40">
      <nav className="flex flex-col items-center justify-center h-full">
        ...
        <div className="flex flex-col items-center">
          ...
          <a href="#" className="mt mb-6 font-bold hover:underline"> {/* Increased mt-2 to mt-4, mb-5 to mb-8 */}
            Dashboard
          </a>
          ...
          <a href="#" className="mt- mb-15 font-bold hover:underline">
            Report
          </a>
          </div>
