    ...
    <div className="p-4">
      <div className="flex flex-col h-full p-5 bg-gray-400 text-black shadow-lg w-36 rounded-3xl">
        <nav className="flex flex-col items-center justify-center">
          ...
          <a href="/grassing" className="mt-2 mb-5 font-semibold hover:underline">
            Dashboard
          </a>

          <img className="w-[20px] mt-3" src={assets.session_icon} alt="" />
          <a href="/session" className="mt-2 mb-5 font-semibold hover:underline">
            Session
          </a>
          ...
          <a href="/inventory" className="mt-2 mb-5 font-semibold hover:underline">
            Profile
          </a>

          <img className="w-[20px] mt-3" src={assets.logout_icon} alt="" />
          <a href="/logout" className="mt-2 mb-5 font-semibold hover:underline">
            Logout
          </a>
        </nav>
      </div>
