...
function MilkingSideBar() {
  return (
    <div>
      {/* Sidebar */}
      <div className="flex flex-col h-50 p-5 bg-gray-400  w-30 rounded-lg mt-3 ml-6 shadow-lg">
        <nav className="flex flex-col items-center justify-center h-full">
          <div className="flex flex-col items-center">
            <img className="w-[20px]" src={assets.dashboard_icon} alt="" />
            ...
            <a
              href="/milkingsession"
              className="mt-2 mb-5 font-bold hover:underline"
            >
              Session
            </a>
            ...
            <a
              href="milkingprofile"
              className="mt-2 mb-5 font-bold hover:underlline"
            >
              Profile
            </a>
          </div>
