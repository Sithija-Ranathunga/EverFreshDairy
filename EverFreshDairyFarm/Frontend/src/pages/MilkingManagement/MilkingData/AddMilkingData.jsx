...
function AddMilkingData() {
    ...
    const handleSubmit = (e) => {
        ...
        const requestData = {
            cowId, // cowId remains a string
            amountofMilk, // amountofMilk remains a string
            temperature,
            duration: Number(duration), // duration is still a number
            qualityCheckResult,
        };
        ...
        axios
            .post("http://localhost:8000/milkingData", requestData)
            .then(() => {
            ...
            .catch((err) => {
                ...
                console.error("Error adding milking data:", err.response);
                if (err.response && err.response.data) {
                    alert("Failed to add milking data: " + err.response.data.message);
                } else {
